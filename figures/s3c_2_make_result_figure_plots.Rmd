...
fig_X <- plot_ly(toPlotX,  width = 300, height = 300, type='scatter3d', mode='markers') %>%
  config(toImageButtonOptions = list(format = "svg",  width = 300, height = 300)) %>%
...
fig_X <- fig_X %>% layout(showlegend = FALSE,
                     ...
                     zaxis = list(title = 'R4', titlefont = t))
                          ...
                          ) %>% config(toImageButtonOptions = list(format = "svg", width = 300,
                                                              height = 300))
