...
# Should be just repeat plots for Figure 3 (simulated gene expression data)
...
dir_to_save_fig <-  "../../out/simulated_gene_expression_main/"
...
```{r}
dso$set_save_dir(paste0(dir_to_save_fig,"/simulations_fig_3_save"))
dso$save_state()
```

## This is how to load model
```{r}
save_dir <- paste0(dir_to_save_fig,"/simulations_fig_3_save")
