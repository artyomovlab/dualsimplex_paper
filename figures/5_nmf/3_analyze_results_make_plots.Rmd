...
# file_name <- paste0(dir_to_save_fig, 'random_noise_', noise_deviation, '_',proportions,'_', current_K ,'K_', current_N, 'N_', current_M, 'M_random-H_10runs_10init_random.rds')
...
result_random$fit_objects$snmf_l <- lapply(result_random$fit_objects$snmf_l, function(result){
...
if (individual_pictures) {
  orig_pictures <-  plot_single_pictures(result_random$data_used[[8]]$true_W, "original_picture", dir_to_save_fig)
} else {

orig_pictures <-  plot_pictures(result_random$data_used[[8]]$true_W,  "original_pictures", dir_to_save_fig)
}
...
result_plots_rmse <- plot_metrics_box(res_methods = result_random$fit_objects, 
                              ...
                              W_signif_step=0, H_signif_step=0, V_signif_step=0,
                             W_signif_margin_top=0.2, H_signif_margin_top=0.05,  V_signif_margin_top=0.05,
                           H_limit = NULL, V_limit = NULL,    W_limit = NULL,
...
result_plots_pearson <- plot_metrics_box(res_methods = result_random$fit_objects, 
                                   ...
                                   title=paste0(metric, "_", noise_nature,"_random_noise_",
                                                   ...
                                                   current_N, 'N_', 
                                                   current_M),
       W_signif_step=0.15, H_signif_step=0.15, V_signif_step=0.14,
                             W_signif_margin_top=0.05, H_signif_margin_top=0.05,
                             V_signif_margin_top=0.05,
                             W_limit = NULL, H_limit = NULL, V_limit = NULL,
                              log_scale_V = T, log_scale_W = T, log_scale_H = T
                             )
...
```{r}
dso <- result_random$fit_objects$DualSimplex[[9]]@misc$obj
data_used <- result_random$data_used[[9]]
```
