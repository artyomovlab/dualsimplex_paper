...
pictures_W <- rhdf5::h5read("../../data/img/merged_imgs.h5", "matrix")
...
run_experiment_picture_random_noizy <- function(current_K, current_M, current_N, pictures_W, n_data_generations = 3, 
                                                  ...
                                                  lr_x =  0.1,
                                                  lr_omega = 0.1,
                                                 noise_deviation=3.5, noise_nature="proportional", n_runs_for_each_model = 10 ) {
  
  data_generated <- lapply(c(1:n_data_generations), function(run_index) make_picture_data_random_mixtures(current_M, current_N, current_K, pictures_W, noise_deviation))
  ...
  total_result <- lapply(c(1:n_data_generations), function(run_index) {
      ...
      current_res_methods <- NMF::nmf(syntetic_data$noizy_V, current_K, list('lee', 'brunet'), .options='vp10', nrun=n_runs_for_each_model)

      print("Compute NMF method 'HALSacc'")
      halsacc_res <- NMF::nmf(syntetic_data$noizy_V, current_K, hNMF::HALSacc, nrun=n_runs_for_each_model, .options='vp10', name="HALSacc")
      ...
      pgnmf_res <- NMF::nmf(syntetic_data$noizy_V, current_K, hNMF::PGNMF, nrun=n_runs_for_each_model, .options='vp10', name="PGNMF")
      ...
      als_nmf_res <- NMF::nmf(syntetic_data$noizy_V, current_K, als_nmf_algorithm, nrun=n_runs_for_each_model, .options='p1', name="ALS")
      ...
      linseed_res <- NMF::nmf(syntetic_data$noizy_V, 
                         ...
                         nrun=n_runs_for_each_model, .options='vp10', name="DualSimplex", 
