...
ggsave(file=filename, plot=res_plot, width=10, height=7, device=svg)
...
ggsave(file=filename, plot=res_plot, width=3, height=3, device=svg)
res_plot
```
...
list_of_plots <- plot_marker_enrichment(so, names(ml_sorted), ncol=7, limits = c(-0.2, 1), function(plt) {
...
ggsave(file=filename, plot=res_plot, width=11, height=10, device=svg)
res_plot
```
