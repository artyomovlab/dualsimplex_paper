...
Testing if we can keep more cells if we first remove outlier genes
```{r}
...
```{r visual-inspection, fig.width=12, fig.height=6}
dso$plot_projection_diagnostics()
...
# Optimizing deconvolution and clustering
```{r load-state}
...
```{r visual-inspection, fig.width = 13, fig.height = 6}
