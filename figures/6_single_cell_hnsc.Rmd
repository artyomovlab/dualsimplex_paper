...
# For reproducibility
knitr::opts_knit$set(root.dir = "/storage1/fs1/martyomov/Active/IndividualBackUps/chia-jung.l/git/dualsimplex_paper")
```
...
Once we got some projection we now are insterested in how good this projeciton is. Should we remove poitns or not.
