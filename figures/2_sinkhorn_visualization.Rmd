...
dso$set_data(V, max_sinkhorn_iterations = 20)
dso$project(K)
...
plot_3d(round(dso$st$proj$X, 5), "R", size = 3, colors = points_col, shift=0)
points_col <- brewer.pal(9, "Oranges")
plot_3d(round(dso$st$proj$Omega, 5), "S", size = 3,  colors = points_col, shift=0)
```
