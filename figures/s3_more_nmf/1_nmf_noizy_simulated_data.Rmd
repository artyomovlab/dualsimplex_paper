...
run_experiment_picture_random_noizy <- function(current_K, current_M, current_N, pictures_W, n_data_generations = 3, 
  ...
  total_result <- lapply(c(1:n_data_generations), function(run_index) {
      ...
      current_res_methods <- nmf(syntetic_data$noizy_V, current_K, list('lee', 'brunet'), .options='vp10', nrun=10)
      ...
      als_nmf_res <- nmf(syntetic_data$noizy_V, current_K, als_nmf_algorithm, nrun=10, .options='p1', name="ALS")
