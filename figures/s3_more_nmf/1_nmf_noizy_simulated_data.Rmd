...
globally_generated_data <- make_simulated_data(current_M, current_N, current_K, noise_deviation =15 )
...
ggarrange(plot_negative_basis_change(dso), plot_negative_proportions_change(dso))
```
