...
if (individual_pictures) {
  orig_pictures <-  plot_single_pictures(result_random$data_used[[1]]$true_W, "original_picture", dir_to_save_fig)
} else {

orig_pictures <-  plot_pictures(result_random$data_used[[1]]$true_W,  "original_pictures", dir_to_save_fig)
}
